...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    TD(DANCE_1),    TD(DANCE_2),    MT(MOD_LCTL, KC_S),MT(MOD_LALT, KC_D),MT(MOD_LGUI, KC_F),KC_G,                                           KC_H,           MT(MOD_RGUI, KC_J),MT(MOD_RALT, KC_K),MT(MOD_RCTL, KC_L),TD(DANCE_4),    MT(MOD_RSFT, KC_QUOTE),
    TD(DANCE_3),    KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       LT(1,KC_EQUAL), 
                                                    LT(1,KC_SPACE), LT(2,KC_TAB),                                   LT(2,KC_TAB),   LT(1,KC_ENTER)
  ),
  [1] = LAYOUT_voyager(
    ALL_T(KC_ESCAPE),MEH_T(KC_F1),   KC_F2,          KC_F3,          KC_F4,          KC_F5,                                          KC_F6,          KC_F7,          KC_F8,          KC_F9,          MEH_T(KC_F10),  ALL_T(KC_F11),  
    KC_GRAVE,       KC_EXLM,        KC_AT,          KC_PERC,        KC_LCBR,        KC_RCBR,                                        KC_PAGE_UP,     KC_HOME,        KC_UP,          KC_END,         KC_ASTR,        KC_F12,         
    ST_MACRO_0,     TD(DANCE_5),    TD(DANCE_6),    MT(MOD_LALT, KC_GRAVE),TD(DANCE_7),    KC_RPRN,                                        KC_PGDN,        KC_LEFT,        KC_DOWN,        KC_RIGHT,       TD(DANCE_8),    MT(MOD_RCTL, KC_GRAVE),
    KC_TRANSPARENT, KC_QUES,        KC_CIRC,        KC_AMPR,        KC_LBRC,        KC_RBRC,                                        KC_TRANSPARENT, LCTL(LSFT(KC_TAB)),LCTL(KC_TAB),   KC_DOT,         MT(MOD_RGUI, KC_EQUAL),KC_TRANSPARENT, 
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [1] = { {152,255,255}, {0,255,255}, {0,255,255}, {0,255,255}, {0,255,255}, {0,255,255}, {41,255,255}, {41,255,255}, {41,255,255}, {41,255,255}, {74,255,255}, {74,255,255}, {41,255,255}, {41,255,255}, {41,255,255}, {41,255,255}, {74,255,255}, {74,255,255}, {169,255,84}, {41,255,255}, {41,255,255}, {41,255,255}, {74,255,255}, {74,255,255}, {169,255,84}, {169,255,84}, {0,255,255}, {0,255,255}, {0,255,255}, {0,255,255}, {0,255,255}, {0,255,255}, {74,255,255}, {74,255,255}, {188,255,255}, {74,255,255}, {41,255,255}, {0,255,255}, {74,255,255}, {188,255,255}, {188,255,255}, {188,255,255}, {208,255,229}, {208,255,229}, {169,255,84}, {135,255,255}, {135,255,255}, {41,255,255}, {208,255,229}, {169,255,84}, {169,255,84}, {169,255,84} },
...
void dance_0_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[0].step) {
        ...
        case DOUBLE_HOLD: register_code16(LALT(KC_DELETE)); break;
...
void dance_0_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[0].step) {
        ...
        case DOUBLE_HOLD: unregister_code16(LALT(KC_DELETE)); break;
